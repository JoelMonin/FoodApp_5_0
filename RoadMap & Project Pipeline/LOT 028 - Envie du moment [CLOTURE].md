...
- [x] **Essai réel de Joel** : ✅ **FAIT et concluant** — « mais si j'ai essayé, ça marche »
  (2026-08-02, après publication). Le critère avait été levé au moment du feu vert (« publie »,
  sans essai préalable) ; Joel a en réalité essayé, et confirme le comportement attendu.
  **Ce lot n'est donc PAS dans le cas des LOTS 019 et 027** (publiés sans vérification
  humaine) : la fonctionnalité est validée à l'usage, pas seulement par les tests.
...
| Essai réel de Joel | ✅ 2026-08-02 — **essayé et concluant** (« ça marche ») |
