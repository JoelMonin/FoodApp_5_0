...
|---|---|---|---|
| [020](LOT%20020%20-%20Ranger%20les%20achats%20%5BA%20PUBLIER%5D.md) | Ranger les achats — une barre collante « 🏠 Ranger N achats » apparaît dès qu'un article est coché : les cochés passent en stock et quittent la liste, les autres ne bougent pas. Fonctionnalité NEUVE (l'oracle ne connaît que « Vider »). **+ un défaut existant corrigé en commit séparé** : `toggleStock` était le seul des 4 chemins de sortie du panier à ne pas effacer la coche, d'où des articles qui revenaient « déjà cochés ». Preuve par retrait 6/6 | **A PUBLIER** — attend le feu vert de Joel (V5.13) | `feat/lot20-ranger-les-achats` |
