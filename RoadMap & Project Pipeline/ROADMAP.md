...
|---|---|---|---|
| [026](LOT%20026%20-%20Prompts%20de%20generation%20%5BEN%20COURS%5D.md) | Prompts de génération — 5 chantiers décidés par Joel après audit des prompts (2026-08-02) : liste des catégories enfin donnée à l'IA, suppression du bouton 🎲 (jugé « du théâtre » : équivalent au curseur à fond), anti-répétition sur 60 minutes, règles de qualité des étapes partagées par les deux prompts, SSOT des consignes communes | **EN COURS** | `feat/lot26-prompts-generation` (chaînée sur lot25) |
