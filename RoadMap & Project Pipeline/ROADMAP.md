...
|---|---|---|---|
| [018](LOT%20018%20-%20Ecran%20inventaire%20dans%20son%20module%20%5BA%20PUBLIER%5D.md) | L'écran inventaire dans son module — **625 → 568 lignes**, et surtout la **première baisse réelle du couplage** de la série (10 points → 9). Sort « sec » : zéro cycle, zéro crochet créé. Trois pièges évités par la découverte, dont un faux ami parfait | **A PUBLIER** — attend le feu vert de Joel (V5.11, avec les 016 et 017) | `feat/lot18-ecran-inventaire` |
